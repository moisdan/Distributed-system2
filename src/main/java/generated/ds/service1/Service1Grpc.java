...
public final class Service1Grpc {
  ...
  private static volatile io.grpc.MethodDescriptor<generated.ds.service1.RequestMessage,
      generated.ds.service1.ResponseMessage> getService1DoMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "service1_do",
      requestType = generated.ds.service1.RequestMessage.class,
      responseType = generated.ds.service1.ResponseMessage.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<generated.ds.service1.RequestMessage,
      generated.ds.service1.ResponseMessage> getService1DoMethod() {
    io.grpc.MethodDescriptor<generated.ds.service1.RequestMessage, generated.ds.service1.ResponseMessage> getService1DoMethod;
      ...
      synchronized (Service1Grpc.class) {
        if ((getService1DoMethod = Service1Grpc.getService1DoMethod) == null) {
          Service1Grpc.getService1DoMethod = getService1DoMethod = 
              io.grpc.MethodDescriptor.<generated.ds.service1.RequestMessage, generated.ds.service1.ResponseMessage>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "service1.Service1", "service1_do"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  generated.ds.service1.RequestMessage.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  generated.ds.service1.ResponseMessage.getDefaultInstance()))
  ...
  public static abstract class Service1ImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void service1Do(generated.ds.service1.RequestMessage request,
        io.grpc.stub.StreamObserver<generated.ds.service1.ResponseMessage> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                generated.ds.service1.RequestMessage,
                generated.ds.service1.ResponseMessage>(
  ...
  public static final class Service1BlockingStub extends io.grpc.stub.AbstractStub<Service1BlockingStub> {
    ...
    /**
     */
    public generated.ds.service1.ResponseMessage service1Do(generated.ds.service1.RequestMessage request) {
  ...
  public static final class Service1FutureStub extends io.grpc.stub.AbstractStub<Service1FutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<generated.ds.service1.ResponseMessage> service1Do(
        generated.ds.service1.RequestMessage request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SERVICE1_DO:
          serviceImpl.service1Do((generated.ds.service1.RequestMessage) request,
              (io.grpc.stub.StreamObserver<generated.ds.service1.ResponseMessage>) responseObserver);
          break;
        default:
